...
export default function StatusProPage() {
        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description="Gestion des différents statuts des professionnels"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun statut trouvé" icon={<Briefcase className="w-10 h-10" />} cols={COLS} />
                            ) : (
