...
import { Info, Map, Tag, Hash } from "lucide-react";
            ...
            <div className="py-2 space-y-6">
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center gap-3">
                    ...
                    <p className="text-xs text-slate-500">
                        Cette région est une subdivision administrative majeure utilisée pour la localisation géographique des établissements et professionnels.
                    </p>
                </div>
            </div>
        </Modal>
