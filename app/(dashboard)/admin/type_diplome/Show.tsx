...
import { Info, GraduationCap, Tag } from "lucide-react";
            ...
            <div className="py-2 space-y-6">
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center gap-3">
                    ...
                    <p className="text-xs text-slate-500">
                        Ce type de diplôme définit une catégorie officielle de qualification reconnue pour les demandes d'agrément.
                    </p>
                </div>
            </div>
        </Modal>
