...
export function Delete({ isOpen, onClose, onSuccess, data, size = "md" }: Props) {
    ...
    const handleDelete = async () => {
        ...
        try {
            await apiFetch(`/niveauIntervention/delete/${data.id}`, {
                method: "DELETE"
            });
            ...
            <div className="py-4 text-center space-y-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Êtes-vous sûr de vouloir supprimer le niveau <span className="font-bold text-slate-700">"{data?.libelle}"</span> ?
