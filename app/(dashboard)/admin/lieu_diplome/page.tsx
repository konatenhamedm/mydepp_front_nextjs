...
export default function LieuDiplomePage() {
    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Lieux de Diplôme"
                    description="Gestion des établissements de délivrance des diplômes"
                ...
                <DataTable
                    ...
                    titleIcon={<Building className="w-4 h-4" />}
                    footer={
                        <Pagination
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun lieu trouvé" icon={<Building className="w-10 h-10" />} cols={COLS} />
                            ) : (
