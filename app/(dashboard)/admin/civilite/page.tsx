...
export default function CivilitePage() {
    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Civilités"
                    description="Gestion des titres et civilités"
                ...
                <DataTable
                    ...
                    titleIcon={<UserCircle className="w-4 h-4" />}
                    footer={
                        <Pagination
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucune civilité trouvée" icon={<UserCircle className="w-10 h-10" />} cols={COLS} />
                            ) : (
