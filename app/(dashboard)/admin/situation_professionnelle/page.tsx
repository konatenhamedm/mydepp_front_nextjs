...
export default function SituationProfessionnellePage() {
    ...
    const refreshData = () => {
        setIsLoading(true);
        apiFetch("/situation_professionnelle/")
            .then((res) => {
        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description="Gestion des situations professionnelles (Public, Privé, etc.)"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucune situation trouvée" icon={<Briefcase className="w-10 h-10" />} cols={COLS} />
                            ) : (
