...
export default function TypeProfessionPage() {
    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Type Profession"
                    description="Gestion des types de professions"
                ...
                />
                <DataTable
                    title="Liste des types de professions"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun type trouvé" icon={<Briefcase className="w-10 h-10" />} cols={COLS} />
                            ) : (
