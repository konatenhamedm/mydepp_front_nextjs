...
export default function NiveauInterventionPage() {
        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description="Gestion des échelons d'intervention (National, Régional, etc.)"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun niveau trouvé" icon={<Layers className="w-10 h-10" />} cols={COLS} />
                            ) : (
