...
export function Delete({ isOpen, onClose, onSuccess, data, size = "md" }: Props) {
    ...
    const handleDelete = async () => {
        ...
        try {
            await apiFetch(`/typeProfession/delete/${data.id}`, {
                method: "DELETE"
            });
        ...
        <Modal
            ...
            title={
                <div className="flex items-center gap-3">
                    ...
                    Supprimer le type de profession
                </div>
            }
            size={size}
            footer={
            ...
            <div className="py-4 text-center space-y-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Êtes-vous sûr de vouloir supprimer le type <span className="font-bold text-slate-700">"{data?.libelle}"</span> ?
