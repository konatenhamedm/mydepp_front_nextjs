...
export default function TypeDiplomePage() {
    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Types de Diplôme"
                    description="Gestion des catégories de diplômes acceptées"
                ...
                />
                <DataTable
                    title="Liste des types de diplôme"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun type trouvé" icon={<GraduationCap className="w-10 h-10" />} cols={COLS} />
                            ) : (
