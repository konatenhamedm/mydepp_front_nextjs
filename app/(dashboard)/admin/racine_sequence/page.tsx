...
export default function RacineSequencePage() {
    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Racine Séquence"
                    description="Gestion des racines pour la génération automatique de codes"
                ...
                />
                <DataTable
                    title="Liste des racines"
                    titleIcon={<Hash className="w-4 h-4" />}
                    footer={
                        <Pagination
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucune racine trouvée" icon={<Hash className="w-10 h-10" />} cols={COLS} />
                            ) : (
