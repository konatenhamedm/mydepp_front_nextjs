...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-[var(--primary-color)] data-[selected-single=true]:text-white data-[range-middle=true]:bg-[var(--primary-color)] data-[range-middle=true]:text-white data-[range-middle=true]:opacity-50 data-[range-start=true]:bg-[var(--primary-color)] data-[range-start=true]:text-white data-[range-end=true]:bg-[var(--primary-color)] data-[range-end=true]:text-white group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
