...
import { Info, MapPin, Tag, Navigation } from "lucide-react";
            ...
            <div className="py-2 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-slate-900 font-semibold text-lg">{data.district_libelle || data.district?.libelle || "N/A"}</p>
                    </div>
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center gap-3">
                    ...
                    <p className="text-xs text-slate-500">
                        Cette ville est localisée dans le district {data.district_libelle || data.district?.libelle}.
                    </p>
                </div>
            </div>
        </Modal>
