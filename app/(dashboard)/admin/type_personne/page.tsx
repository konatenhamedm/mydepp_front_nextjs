...
export default function TypePersonnePage() {
        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description="Gestion des catégories de personnes (Physique, Morale, etc.)"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun type trouvé" icon={<Users className="w-10 h-10" />} cols={COLS} />
                            ) : (
