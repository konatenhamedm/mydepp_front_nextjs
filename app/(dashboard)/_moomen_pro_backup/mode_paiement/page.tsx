...
import { Plus, CreditCard, Store } from "lucide-react";
        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description={`Modes de paiement du magasin ${magasin?.libelle ?? ""}`}
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun mode de paiement trouvé" icon={<CreditCard className="w-10 h-10" />} cols={COLS} />
                            ) : (
