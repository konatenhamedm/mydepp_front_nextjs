    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Directions"
                    description="Gestion des directions et structures administratives"
                ...
                <DataTable
                    ...
                    titleIcon={<Compass className="w-4 h-4" />}
                    footer={
                        <Pagination
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucune direction trouvée" icon={<Compass className="w-10 h-10" />} cols={COLS} />
                            ) : (
