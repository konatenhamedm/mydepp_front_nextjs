    ...
    return (
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    title="Destinataires"
                    description="Gestion des destinataires des courriers et documents"
                ...
                <DataTable
                    ...
                    titleIcon={<Send className="w-4 h-4" />}
                    footer={
                        <Pagination
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun destinataire trouvé" icon={<Send className="w-10 h-10" />} cols={COLS} />
                            ) : (
