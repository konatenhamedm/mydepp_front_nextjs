...
import { Loader2, Coins, Hash } from "lucide-react";
...
export function Add({ isOpen, onClose, onSuccess }: AddProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await apiFetch("/devises/create", {
                method: "POST",
                data: {
                    code: formData.code,
            ...
            if (res) {
                ...
                onSuccess();
                onClose();
                setFormData({ code: "", symbole: "", nb_decimal: "0" });
            }
        } catch (error: any) {
            console.error(error);
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 bg-white">
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="symbole" className="text-[#0052cc] font-semibold">
                                    Symbole
                                </Label>
                                <Input
                                    id="symbole"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="nb_decimal" className="text-[#0052cc] font-semibold flex items-center gap-2">
