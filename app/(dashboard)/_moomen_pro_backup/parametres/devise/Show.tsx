...
import { Coins, Hash, Calendar, Globe } from "lucide-react";
                ...
                <div className="p-6 space-y-4 bg-white">
                    <div className="grid grid-cols-1 gap-4">
                        <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Code ISO</p>
                                <p className="text-sm font-bold text-slate-700">{data.code}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Symbole</p>
                                <p className="text-sm font-bold text-slate-700">{data.symbole}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 p-3 rounded-xl bg-slate-50 border border-slate-100 group">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Nombre de décimales</p>
                                <p className="text-sm font-bold text-slate-700">{data.nb_decimal} décimales</p>
                            </div>
                        </div>
