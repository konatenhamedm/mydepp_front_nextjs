        ...
        <ClientOnly>
            <div className="space-y-5">
                <PageHeader
                    ...
                    description="Gestion des types de documents d'identité et administratifs"
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <EmptyState message="Aucun type trouvé" icon={<FileText className="w-10 h-10" />} cols={COLS} />
                            ) : (
